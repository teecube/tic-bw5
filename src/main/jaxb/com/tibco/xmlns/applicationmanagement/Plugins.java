...
public class Plugins {
    ...
    @XmlElementRef(name = "DeploymentDescriptor", namespace = "http://www.tibco.com/xmlns/dd", type = JAXBElement.class, required = false)
    protected List<JAXBElement<? extends DeploymentDescriptorType>> deploymentDescriptor;
    @XmlElementRef(name = "extends", namespace = "http://www.tibco.com/xmlns/ApplicationManagement", type = JAXBElement.class, required = false)
